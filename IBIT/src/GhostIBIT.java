			...
			while( (strLine = br.readLine()) != null){
				...
				while(st.hasMoreTokens()){
					...
					if(st.nextToken().equals(Site)){
						...
						if((Math.abs((Integer.parseInt(previous)-Integer.parseInt(recivedData.get(3),16))/(Integer.parseInt(previous)))*100)>=Integer.parseInt(limits.get(3))){
							failed=true;
							foward=true;
						}previous=st.nextToken();
						try{
							if((Math.abs((Integer.parseInt(previous)-Integer.parseInt(recivedData.get(4),16))/(Integer.parseInt(previous)))*100)>=Integer.parseInt(limits.get(3))){
								failed=true;
								refelcted=true;
							}
						}catch(ArithmeticException e){
						...
						st.nextToken();
						previous=st.nextToken();
						if((Math.abs((Integer.parseInt(previous)-Integer.parseInt(recivedData.get(5),16)))/(Integer.parseInt(previous))*100)>=Integer.parseInt(limits.get(3))){
							failed=true;
							sensitv=true;
						}previous=st.nextToken();
